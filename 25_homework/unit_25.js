...
function fetch(method, aCode, params, out) {
    ...
    switch (method) {
        case "GET":
            xhttp.open(method, URL + "?" + getStr, true);
            xhttp.send();
            break;
        case "POST":
...
function t4() {
    ...
    fetch("GET", 4, { num1: 2, num2: 66 }, out);
}
...
function t6() {
    ...
    fetch("GET", 6, { num1: Infinity, num2: NaN }, out);
}
...
function t12() {
    ...
    fetch("POST", 3, { num1: 44, num2: -44 }, out);
}
...
function t13() {
    ...
    fetch("POST", 4, { num1: -10, num2: 10 }, out);
}
...
function t15() {
    ...
    fetch("POST", 6, { num1: 2, num2: 1 }, out);
}
