...
function t4() {
    ...
    a4.map(item => item === +item && a4_res.push(item));
...
function t6() {
    ...
    b6_res = b6.filter(item => item === +item);
...
function t7() {
    ...
    b7_res = b7.filter(item => item !== +item).filter(item => item.length > 3);
...
function t8() {
    ...
    b8.filter((item, index) => {
        if (item % 2 === 0) if (item === +item) b8_res.push(index);
        return false;
    });
...
function t9() {
    ...
    b9.filter(item => {
        if (item === +item) b9_num.push(item);
        else b9_string.push(item);
        return false;
    });
...
function t10() {
    ...
    b10_res = b10.filter(arr => arr.includes(3));
